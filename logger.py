class Logger(object):
    ...
    def log_interaction(self, person, random_person, random_person_sick=None,
        ...
        if did_infect == True and random_person_sick == False and random_person_vacc == True:
           file.write(f"{random_person._id} didn't infect {person._id}\n")
    ...
    def log_infection_survival(self, person, did_die_from_infection):
        ...
        if did_die_from_infection:
            file.write(f"{person._id} died from {person.infection}\n")
        else:
            file.write(f"{person._id} survived {person.infection}\n")
